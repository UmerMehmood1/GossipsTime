...
public class ShowUsers extends AppCompatActivity {
    ...
    protected void onStart() {
        ...
        FirestoreRecyclerOptions<UserModal> options = new FirestoreRecyclerOptions.Builder<UserModal>().setQuery(query,UserModal.class).build();

        FirestoreRecyclerAdapter firestoreRecyclerAdapter =new FirestoreRecyclerAdapter<UserModal,UserVH>(options){
