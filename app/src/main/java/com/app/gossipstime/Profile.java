...
public class Profile extends AppCompatActivity {
    ...
    ImageView profileiv;
    TextView nametv,phonetv,abouttv,showblockedtv;
    Button button,logoutbtn,btnOk;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        showblockedtv = findViewById(R.id.showblockedtv);
        ...
        showblockedtv.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

                Intent i = new Intent(Profile.this,ShowBlocked.class);
                startActivity(i);
        ...
        logoutbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent i = new Intent(Profile.this, LogInOptions.class);
                startActivity(i);
                finish();
        ...
        btnOk.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Profile.this ,TabAct.class);
