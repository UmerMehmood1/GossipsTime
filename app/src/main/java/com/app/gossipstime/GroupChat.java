...
public class GroupChat extends AppCompatActivity {
    ...
    ImageButton moreoption,sendbtngc,pickimagesbtn;
    RecyclerView recyclerView;
    FirebaseDatabase database = FirebaseDatabase.getInstance();
    DatabaseReference groupchat,schatlist,sRef,rRef,rchatlist,groupRef,lastmREf;
    String groupname,address,adminid,url,currentuid,sendername,sname,surl,
            rname,rurl,sphone,rphone,savetime;
    EditText messageEt;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pickimagesbtn = findViewById(R.id.pickfilebtn);
        ...
        pickimagesbtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(GroupChat.this,ShareImageGC.class);
                intent.putExtra("gname",groupname);
                intent.putExtra("address",address);
                intent.putExtra("url",url);
                intent.putExtra("admin",adminid);
                ...
                new FirebaseRecyclerAdapter<GroupChatModal, GroupChatVH>(options) {
                    ...
                    protected void onBindViewHolder(@NonNull GroupChatVH holder, int position, @NonNull GroupChatModal model) {
                        ...
                        holder.setgroupmessage(getApplication(),model.getSname(),model.getMessage(),model.getTime(),model.getDelete()
                                ,model.getSeen(),model.getSearch(),model.getSuid(),model.getType(),model.getUrl());
